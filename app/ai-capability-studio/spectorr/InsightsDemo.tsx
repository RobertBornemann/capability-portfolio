    ...
    <main className="mx-auto max-w-7xl p-6 space-y-8">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-neutral-500">
          Real-time processing of analyst notes and market commentary built with Next.js, FastAPI,
          Python and Claude AI (Anthropic)
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {['ingesting', 'analyzing', 'complete'].includes(stage) ? (
                ...
                <Database
                  className={`w-6 h-6 flex-shrink-0 ${
                    stage === 'initializing' ? 'text-blue-600' : 'text-neutral-400'
                  }`}
                />
              )}
              <div>
            ...
            >
              {stage === 'complete' ? (
                ...
                <Brain
                  className={`w-6 h-6 flex-shrink-0 ${
                    stage === 'analyzing' ? 'text-blue-600 animate-pulse' : 'text-neutral-400'
                  }`}
                />
              )}
              <div>
          ...
          <div className="grid gap-6">
            {insights.map((it, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-white rounded-lg border-2 shadow-sm hover:shadow-md transition-shadow overflow-hidden"
                >
                  {/* Header */}
                  <div className="px-6 py-4 bg-gradient-to-r from-neutral-50 to-white border-b">
                    <div className="flex items-start justify-between">
                      ...
                      <div
                        className={`flex items-center gap-2 px-4 py-2 rounded-full border-2 ${sentimentColor}`}
                      >
                        <SentimentIcon className="w-5 h-5" />
                        <span className="font-semibold capitalize">{it.insight.tone}</span>
                        <span className="text-sm">
                          · {Math.round(it.insight.confidence * 100)}%
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-6 py-3 bg-neutral-50 text-xs text-neutral-500 flex items-center justify-between">
                    <span>
                      Analysis method:{' '}
                      <code className="px-1.5 py-0.5 bg-neutral-200 rounded">
                        {it.insight.method}
                      </code>
                    </span>
            ...
            <div className="bg-white border-2 border-neutral-200 rounded-lg p-6 space-y-4">
              ...
              <ul className="space-y-3 text-sm text-neutral-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>Daily per-asset insights:</strong> summary, key drivers, risk cues,
                    tone, confidence.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>Portfolio view:</strong> quick read of where sentiment is rising,
                    turning, or diverging from price.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>Auditability:</strong> each insight ties back to dated sources and an
                ...
                <li className="flex gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>Professional clarity:</strong> clean language that reads like an
                    internal note.
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white border-2 border-neutral-200 rounded-lg p-6 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-neutral-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>Generates sample data:</strong> analyst notes, investor feedback, market
                    commentary.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-purple-600">•</span>
                  <span>
                    <strong>Ingest & clean:</strong> normalizes data into asset_id, text,
                    source_date, sentiment_score with basic hygiene.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-purple-600">•</span>
                  <span>
                    <strong>Model & summarize:</strong> Claude reads per asset/day and returns
                    summary, drivers, risks, tone, confidence (versioned prompt).
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-purple-600">•</span>
                  <span>
                    <strong>Serve & visualize:</strong> A FastAPI backend exposes insights and
                    sentiment aggregates for the next.js UI.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border-2 border-neutral-200 rounded-lg p-6 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-neutral-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>More sources:</strong> broker research, transcripts, earnings snippets,
                    social finance
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-600">▸</span>
                  <span>
                    <strong>Model flexibility:</strong> additional providers; route by cost,
                    latency, or sensitivity
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-600">▸</span>
                  <span>
                    <strong>Chunking & routing:</strong> smart grouping per asset/day with retries,
                    backoff, budget guards
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-600">▸</span>
                  <span>
                    <strong>Caching & history:</strong> snapshot insights by day for trend lines and
                    &ldquo;what changed&rdquo; diffs
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-green-600">▸</span>
                  <span>
                    <strong>Role-aware views:</strong> PM overview, analyst deep-dives,
            ...
            <div className="bg-white border-2 border-neutral-200 rounded-lg p-6 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-neutral-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>Signal over noise:</strong> concise, explainable outputs that can be
                    scanned in seconds
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-amber-600">✓</span>
                  <span>
                    <strong>Governable by default:</strong> versioning, clear provenance (method,
                    confidence, source dates)
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-amber-600">✓</span>
                  <span>
                    <strong>Cost-aware:</strong> batching, token caps; easy to swap models or set
                    demo limits
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-amber-600">✓</span>
                  <span>
                    <strong>Separation of concerns:</strong> pipeline, backend, frontend clearly
                    separated
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-amber-600">✓</span>
                  <span>
                    <strong>Enterprise-ready:</strong> SSO and workspace governance
                  </span>
                </li>
              </ul>
            </div>
